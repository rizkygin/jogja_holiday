...
public class RecyclerViewAdapterbukit extends RecyclerView.Adapter<RecyclerViewAdapterbukit.MyViewHolder> {
    Context mContext;
    List<bukitModel> mData;

    public RecyclerViewAdapterbukit(Context mContext, List<bukitModel> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        vHolder.spesific_wisata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int posB  = vHolder.getAdapterPosition() + 1 ;

                Bundle bundle = new Bundle();
                bundle.putString("positionBukit",String.valueOf(posB));
